...
import de.atns.playground.couchdb.client.EquipmentEditorAction;
import de.atns.playground.couchdb.client.TemplateEditorAction;
...
// ------------------------------ FIELDS ------------------------------
    ...
    public static final CouchDB DB = CouchDB.create("gwt");
